...
<body>
  ...
  <ul class="navbar-nav">
    <li class="nav-item">
    <a class="nav-link" href="<%=request.getContextPath()%>/board/list">게시판</a></li>
    <!-- Dropdown -->
    ...
    <li class="nav-item active"><a class="nav-link" href="<%=request.getContextPath()%>/signout">로그아웃</a>
  </ul>
  </nav>
      ...
      <div class="input-group mt-3 mb-3">
        <div class="form-group" style="margin: 0";>
          <select class="form-control" name="type">
            ...
            <option value=3 <c:if test="${pageMaker.criteria.type == 3}">selected</c:if>>제목+내용</option>
          </select>
          </div>
